...
{
    public class PriceCalculation_CalculatePriceForService_Service_B : PricingCalculator_TestBase
    {
        [OneTimeSetUp]
        ...
        public void PriceCalculateService_CalculatePriceForService_Customer_Referense_null_Test()
        {
            ...
            // Act
            // actual
            Assert.Throws<ArgumentNullException>(() => this.m_PriceCalculateService.CalculatePriceForService(CallingService.SERVICE_B, customer, dtStartDate, dtEndDate));
        ...
        public void PriceCalculateService_CalculatePriceForService_StartDate_After_EndDate_Test()
        {
            ...
            // Act
            // actual
            Assert.Throws<ArgumentException>(() => this.m_PriceCalculateService.CalculatePriceForService(CallingService.SERVICE_B, customer, dtStartDate, dtEndDate));
        ...
        public void PriceCalculateService_CalculatePriceForService_Customer_HasItsOwnCostForService_Test()
        {
            ...
            // Act
            // actual
            double dblActualCost = this.m_PriceCalculateService.CalculatePriceForService(CallingService.SERVICE_B, customer, dtStartDate, dtEndDate);
        ...
        public void PriceCalculateService_CalculatePriceForService_Customer_Use_base_cost_from_config_HasDiscount_In_Period_Test()
        {
            ...
            customer.DiscountForServiceB.HasDiscountForAPeriod = true;
            customer.DiscountForServiceB.StartDate = new DateTime(2021, 11, 06);
            customer.DiscountForServiceB.EndDate = new DateTime(2021, 11, 08);
